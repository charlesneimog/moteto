...
function POEMAS_LEN(poema) {
  ...
  while (result.length < TARGETLEN) {
    for (let i = 0; i < poema.length; i++) {
      ...
      const randomRepetitionCount = getRandomRepetitionCount(
        TARGETLEN / poema.length,
        deviation,
      );
...
const CAMINHAM_NO_DESERTO_NORMAL = [
  ...
  [
    ...
    ["que", "a", "pe", "le", "des", "te", "tan", "to", "é", "tão", "fi", "na"],
...
const SOBRE_A_AREIA_NORMAL = [
  [
    ...
    ["per", "ce", "ben", "do", "se", "de", "car", "ne", "ar", "ma", "du", "ra"],
  ...
  [
    ...
    [
      0.01, 0.06, 0.03, 0.02, 0.07, 0.04, 0.05, 0.03, 0.06, 0.06, 0.06, 0.09,
      0.09, 0.02, 0.12, 0.01, 0.02, 0.04, 0.12,
    ],
  ],
  ...
  [
    ...
    ["co", "mo", "era", "im", "pe", "ri", "o", "so", "que", "fi", "zes", "se"],
  ...
  [
    "Como era imperioso que o fizesse.",
    ["co", "mo", "era", "im", "pe", "ri", "o", "so", "que", "fi", "zes", "se"],
    [0.12, 0.09, 0.18, 0.11, 0.08, 0.15, 0.02, 0.06, 0.02, 0.04, 0.11, 0.02],
  ],
];
...
const VEEM_ADAO_EVA_NORMAL = [
  [
    ...
    [
      0.08, 0.07, 0.02, 0.05, 0.08, 0.02, 0.1, 0.05, 0.05, 0.04, 0.09, 0.03,
      0.05, 0.12, 0.1, 0.05, 0.0,
    ],
  ],
  [
  ...
  [
    ...
    [
      0.07, 0.0, 0.1, 0.1, 0.03, 0.07, 0.03, 0.05, 0.06, 0.0, 0.08, 0.09, 0.08,
      0.1, 0.0, 0.02, 0.04, 0.01, 0.07, 0.0,
    ],
  ],
  [
  ...
  [
    ...
    [
      0.1, 0.0, 0.07, 0.09, 0.1, 0.04, 0.0, 0.01, 0.08, 0.02, 0.06, 0.04, 0.1,
      0.09, 0.1, 0.05, 0.02, 0.03,
    ],
  ],
  [
  ...
  [
    ...
    [
      0.03, 0.0, 0.03, 0.09, 0.06, 0.05, 0.0, 0.0, 0.03, 0.08, 0.1, 0.0, 0.08,
      0.0, 0.02, 0.08, 0.06, 0.05, 0.1, 0.06, 0.01, 0.01, 0.04, 0.02,
    ],
  ],
  [
    "Assim quis o senhor:",
  ...
  [
    ...
    [
      0.0, 0.05, 0.02, 0.04, 0.01, 0.09, 0.0, 0.1, 0.01, 0.1, 0.06, 0.01, 0.01,
      0.09, 0.04, 0.1, 0.05, 0.03, 0.08, 0.11,
    ],
  ],
  [
    "De criaturas,",
  ...
  [
    ...
    [0.09, 0.04, 0.12, 0.09, 0.11, 0.06, 0.12, 0.01, 0.11, 0.11, 0.03, 0.11],
  ],
  [
  ...
  [
    ...
    [0.05, 0.02, 0.08, 0.19, 0.02, 0.06, 0.05, 0.18, 0.07, 0.04, 0.18, 0.06],
  ],
  ...
  [
    ...
    [0.02, 0.09, 0.05, 0.08, 0.11, 0.1, 0.06, 0.07, 0.1, 0.1, 0.11, 0.04, 0.07],
  ],
  ...
  [
    ...
    [
      0.16, 0.1, 0.08, 0.12, 0.13, 0.08, 0.01, 0.11, 0.14, 0.02, 0.0, 0.03,
      0.02,
    ],
  ],
  [
...
if (microEventTuplet == 1) {
  ...
  microEvent.notesProbabilities = [0.1, 0.1, 0.1, 0.7];
  microEvent.syllables = POEMA[PHRASE][1];
  microEvent.syllablesProbabilities = POEMA[PHRASE][2];
  microEvent.completePhrase = POEMA[PHRASE][0];
  PHRASE += 1;
  ...
  microEvent.notesProbabilities = [0.1, 0.4, 0.3, 0.2];
  microEvent.syllables = POEMA[PHRASE][1];
  microEvent.syllablesProbabilities = POEMA[PHRASE][2];
  microEvent.completePhrase = POEMA[PHRASE][0];
  PHRASE += 1;
  ...
  microEvent.notesProbabilities = [0.4, 0.2, 0.3, 0.1];
  microEvent.syllables = POEMA[PHRASE][1];
  microEvent.syllablesProbabilities = POEMA[PHRASE][2];
  microEvent.completePhrase = POEMA[PHRASE][0];
  PHRASE += 1;
...
if (microEventTuplet == 1) {
  ...
  for (var i = 0; i < tupletValue; i++) {
    ...
    microEvent.syllablesProbabilities = POEMA[PHRASE][2];
    microEvent.completePhrase = POEMA[PHRASE][0];
    microEvent.notes2replace = [
      6386, 7087, 6772, 6154, 6589, 6937, 6026, 6274, 6490,
    ];
    microEvent.breathTime = breathTimeValue;
    microEvent.replaceNotes = true;
    microEvent.possibleDurations = [tupletValueMs];
  ...
  for (var i = 0; i < tupletValue; i++) {
    ...
    microEvent.completePhrase = POEMA[PHRASE][0];
    microEvent.notes2replace = [
      6386, 7087, 6772, 6154, 6589, 6937, 6026, 6274, 6490, 6683, 6856, 7014,
      7158,
    ];
    microEvent.breathTime = breathTimeValue;
    microEvent.replaceNotes = true;
...
if (
  Math.round(pieceEvents.getDuration()) !=
  (167500 + 60000) * TIME_MULTIPLIER
) {
  alert(
    "Algum erro aconteceu, duração total: " +
      pieceEvents.getDuration() * TIME_MULTIPLIER,
  );
}
...
if (microEventTuplet == 1) {
  ...
  for (var i = 0; i < tupletValue; i++) {
    ...
    if (replaceNotesProb < 0.3) {
      microEvent.replaceNotes = true;
      microEvent.notes2replace = [
        6600, 6182, 6947, 6853, 6431, 7194, 6449, 6378,
      ];
    }
    microEvent.syllables = POEMA[PHRASE][1];
    microEvent.syllablesProbabilities = POEMA[PHRASE][2];
...
if (
  Math.round(pieceEvents.getDuration()) !=
  (110000 + 167500 + 60000) * TIME_MULTIPLIER
) {
  alert(
    "Algum erro aconteceu, duração total: " +
      pieceEvents.getDuration() * TIME_MULTIPLIER,
...
console.log(
  "The duration is: " +
    Math.floor(duracaoTotal / 60000) +
    ":" +
    Math.floor((duracaoTotal % 60000) / 1000),
);
